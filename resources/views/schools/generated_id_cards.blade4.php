...
<head>
    ...
    <style>
        ...
        */
        ...
        | per-orientation so the exact card count (10 horizontal / 12 vertical)
        ...
        */
        ...
        /* 3 columns x 4 rows = 12 cards, each 64.6mm x 69.5mm */
        .a4-page.orientation-vertical {

            grid-template-columns: repeat(3, 64.6mm);
            grid-template-rows: repeat(4, 69.5mm);
        }
        ...
        */
        ...
        | tall horizontal card vs a much smaller 64.6mm wide vertical card.
        |--------------------------------------------------------------------------
        */
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | VERTICAL LAYOUT (portrait card, 64.6mm x 69.5mm)
        |--------------------------------------------------------------------------
        */
