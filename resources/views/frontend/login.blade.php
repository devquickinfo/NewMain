...
<body class="hold-transition login-page" style="background: url('{{ asset('login.avif') }}') no-repeat center center fixed; background-size: cover;">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ url('/') }}" class="h1"><b>School </b>Admin</a>
    </div>
    <div class="card-body">
